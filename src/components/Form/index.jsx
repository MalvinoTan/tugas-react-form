    ...
    return (
        <form className={styles.form} onSubmit={handleSubmit}>
            ...
            <div className={styles.form_input}>
                ...
                <input className={styles.radio} type="radio" name="pendidikan" value="IT" onChange={handleInput} checked={inputs.pendidikan.it} required /><label>IT</label>
                <input className={styles.radio} type="radio" name="pendidikan" value="NonIT" onChange={handleInput} checked={inputs.pendidikan.nonIt} /><label>Non IT</label>
            </div>
            ...
            <span className={styles.error}>{errorMessage.nama}</span><br />
            <span className={styles.error}>{errorMessage.email}</span><br />
            <span className={styles.error}>{errorMessage.noHandphone}</span><br />

            <button className={`${styles.btn} ${styles.btn_submit}`} type="submit">Submit</button>
            <button className={`${styles.btn} ${styles.btn_reset}`} type="button" onClick={handleReset}>Reset</button>
        </form>
    );
}
